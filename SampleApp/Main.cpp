...
char gConnectDevTypeMenu[] = {
    ...
    "\r\n 2 : TE-V1"
    "\r\n 3 : TE-Q2"
    "\r\n 4 : Engine (TE-EQ1/TE-EV1/TE-EQ2/TE-EV2)"
    "\r\n "
    "\r\n x : Exit"
    "\r\n "
    "\r\n "
...
void ConnectDevice(int _model, int _devNum){
    TEScanData devs[MAX_USB_NUM];
    if(ScanTE(devs) == 1){
        if((devs[_devNum].bDevCon == 0)
           ||
           ((_model == 1 || _model == 2 || _model == 3) && devs[_devNum].nProdVer != 0)
           ||
           (_model == 4 && (devs[_devNum].nProdVer != I3_TE_EQ1 && devs[_devNum].nProdVer != I3_TE_EV1 && devs[_devNum].nProdVer != I3_TE_EQ2 && devs[_devNum].nProdVer != I3_TE_EV2))){
    ...
    case 2:
        ...
        break;
    case 3:
        gTE_B = OpenTE_B(I3_TE_Q2, _devNum);
        break;
    case 4:
